...
<!-- Everything below is generated by bd and carries content hashes; editing it
     causes drift on the next `bd setup`. bd's output is not markdownlint-clean
     (both managed blocks emit a "Beads Issue Tracker" heading, and its fences
     and lists lack surrounding blank lines), so these rules are suppressed for
     generated content only. Hand-written sections above are still linted. -->
...
<!-- markdownlint-enable MD024 MD031 MD032 -->
